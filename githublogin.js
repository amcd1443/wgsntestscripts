...
driver.saveScreenshot('landing_page.png');
...
//below is a test to make sure scripts are correctly running
clickAndWait('octicon octicon-mark-github','test test test · GitHub'); // clicking octicat image and checking youre on the home page
